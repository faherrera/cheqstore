...
let AddToCart = $(".AddToCart"); //Capturo los elemento de class .AddToCart



//Funcion para disparar toast al realizar el evento pertinente
function DispatchToast() {
    Materialize.toast('Agregando a tu carrito', 2 * 1000)
}
...
AddToCart.hover(DispatchToast, function () { }); //Evento que disparará la funcion DispatchToast
